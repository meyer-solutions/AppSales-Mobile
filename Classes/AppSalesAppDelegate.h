...
@interface AppSalesAppDelegate : NSObject <UIApplicationDelegate, AccountsViewControllerDelegate, KKPasscodeViewControllerDelegate, PaymentViewControllerDelegate> {
	UIWindow *window;
